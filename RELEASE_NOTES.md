...
- Windows 编译配方使用系统 Windows PowerShell 5.1，取消外部 shell 工具包依赖。
- 清理实验性工具、旧同步脚本和重复的工具链文件；维护脚本及源码补丁不进入用户安装包。
- 0.0.2、0.0.3 的 Release、标签和安装索引已撤下；当前暂停提供安装版。

# 0.0.3（已撤下；原发布日期 2026-09-15）
